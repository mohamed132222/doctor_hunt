...
///
/// Built on 2026-09-19 at 15:02 UTC
...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  String get distanceAway => '{distance} away';
  ...
  String get experienceYears => '{years} Years experience';

  String get featureDoctorsTitle => 'Feature Doctor';

  String get fieldRequired => 'Enter {label}';
  ...
  String get nextAvailabilityOn => 'Next availability on {day}';
  ...
  String get otpRequired => 'Enter the {length}-digit code';
  ...
  String get patientStories => '{count} Patient Stories';

  String get perHourShort => '/hr';

  String get perHourSuffix => '/ hours';

  String get periodSlots => '{period} {count} slots';
  ...
  String get reminderMinutes => '{minutes} min';
  ...
  String get satisfactionPercent => '{percent}%';
  ...
  String get slotsAvailable => '{count} slots available';
  ...
  String get tabPlaceholder => '{title} screen';
...
class _StringsAr implements Translations {
  ...
  @override
  String get distanceAway => 'يبعد {distance}';
  ...
  @override
  String get experienceYears => '{years} سنوات خبرة';

  @override
  String get featureDoctorsTitle => 'أطباء مميزون';

  @override
  String get fieldRequired => 'أدخل {label}';
  ...
  @override
  String get nextAvailabilityOn => 'أقرب موعد متاح {day}';
  ...
  @override
  String get otpRequired => 'أدخل الرمز المكوّن من {length} أرقام';

  @override
  String get passwordHint => 'كلمة المرور';

  @override
  String get passwordMinLength => 'كلمة المرور يجب ألا تقل عن {minLength} أحرف';
  ...
  @override
  String get patientStories => '{count} قصة مريض';
  ...
  @override
  String get periodSlots => '{period} {count} موعد';
  ...
  @override
  String get reminderMinutes => '{minutes} دقيقة';
  ...
  @override
  String get slotsAvailable => '{count} موعد متاح';
  ...
  @override
  String get tabPlaceholder => 'شاشة {title}';
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'nextAvailabilityOn':
        return 'Next availability on {day}';
      ...
      case 'patientNameHint':
        return 'Patient Name';
      case 'patientStories':
        return '{count} Patient Stories';
      case 'perHourShort':
        return '/hr';
      case 'perHourSuffix':
        return '/ hours';
      case 'periodSlots':
        return '{period} {count} slots';
      case 'phoneInvalid':
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'patientNameHint':
        return 'اسم المريض';
      case 'patientStories':
        return '{count} قصة مريض';
      case 'perHourShort':
        return '/ساعة';
      case 'perHourSuffix':
        return '/ الساعة';
      case 'periodSlots':
        return '{period} {count} موعد';
      case 'phoneInvalid':
