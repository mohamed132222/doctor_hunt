      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          constraints: BoxConstraints(
            minHeight: context.w(AppSize.choiceChipHeight),
          ),
          padding: EdgeInsets.symmetric(
            horizontal: context.w(AppSize.s8),
            vertical: context.w(AppSize.s8),
          ),
          decoration: BoxDecoration(
            color: selected
                ? scheme.primary
                : scheme.primary.withValues(alpha: AppSize.slotIdleAlpha),
            borderRadius: BorderRadius.circular(context.r(AppSize.r24)),
          ),
