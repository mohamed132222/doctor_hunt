...
class _AppointmentConfirmedDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final radius = BorderRadius.circular(context.r(AppSize.dialogRadius));

    return Dialog(
      backgroundColor: scheme.surface,
      shape: RoundedRectangleBorder(borderRadius: radius),
      insetPadding: EdgeInsets.symmetric(
        horizontal: context.w(AppSize.dialogInset),
        vertical: context.w(AppSize.s24),
      ),
      child: Padding(
        padding: EdgeInsets.all(context.w(AppSize.dialogPadding)),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Container(
              width: context.w(AppSize.dialogIconBadge),
              height: context.w(AppSize.dialogIconBadge),
              ...
              child: Icon(
                ...
                size: context.w(AppSize.dialogIconGlyph),
            ...
            SizedBox(
              height: context.w(AppSize.confirmHeight),
