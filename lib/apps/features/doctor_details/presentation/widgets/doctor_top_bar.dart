...
class DoctorTopBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final size = context.w(AppSize.detailsBackButton);
    ...
    return Padding(
      ...
      child: ConstrainedBox(
        constraints: BoxConstraints(
          minHeight: context.w(AppSize.detailsTopBarHeight),
        ),
        child: Row(
          children: [
            _SquareButton(
            ...
            if (!centerTitle) SizedBox(width: context.w(AppSize.s12)),
  ...
  Widget build(BuildContext context) {
    ...
    final shape = RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(
        context.r(AppSize.detailsActionRadius),
      ),
    );
    final button = SizedBox(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Icon(
            icon,
            size: context.w(AppSize.detailsActionIcon),
