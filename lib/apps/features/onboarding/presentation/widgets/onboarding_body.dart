...
class _OnboardingBodyState extends State<OnboardingBody> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      fit: StackFit.expand,
      children: [
        // Full-bleed surface so the screen never shows through.
        ...
        Align(
          ...
          child: Transform.translate(
            offset: Offset(context.w(60), context.h(60)),
            child: Image.asset(
              AppAssets.onboardingGlow,
              width: context.w(AppSize.onboardingGlowWidth),
        ...
        AnimatedAlign(
          ...
          child: Transform.flip(
            ...
            child: Image.asset(
              ...
              width: context.w(AppSize.onboardingShapeWidth),
              errorBuilder: (context, error, stackTrace) =>
                  const SizedBox.shrink(),
            ),
          ),
        ...
        Positioned.fill(
          child: Column(
            children: [
              SizedBox(height: context.h(AppSize.onboardingImageTop)),
              Expanded(
              ...
              Padding(
                padding: EdgeInsets.symmetric(horizontal: context.w(42)),
                child: PrimaryButton(
              ...
              SizedBox(height: context.h(AppSize.onboardingButtonSkipGap)),
              TextButton(
                onPressed: _goNext,
              ...
              SizedBox(
                height:
                    ...
                    context.h(AppSize.onboardingBottomPadding),
              ),
            ],
          ),
        ),
