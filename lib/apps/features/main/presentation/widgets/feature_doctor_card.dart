...
class _FeatureDoctorCardState extends State<FeatureDoctorCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final radius = BorderRadius.circular(context.r(AppSize.r12));
    ...
    return SizedBox(
      width: context.w(AppSize.featureCardWidth),
      height: context.w(AppSize.featureCardHeight) + textExtra,
      child: DecoratedBox(
        ...
        child: ClipRRect(
          ...
          child: Material(
            ...
            child: InkWell(
              onTap: widget.onTap,
              child: Padding(
                padding: EdgeInsets.all(context.w(AppSize.s6)),
                child: Column(
                  children: [
                    Row(
                      children: [
                        GestureDetector(
                          ...
                          child: Icon(
                            ...
                            size: context.w(AppSize.featureIconSize),
                            color: _favorite
                                ? scheme.error
                        ...
                        SizedBox(width: context.w(AppSize.s2)),
                        Text(
                    ...
                    Flexible(
                      child: Hero(
                        ...
                        child: FittedBox(
                          ...
                          child: ClipOval(
                            child: SizedBox(
                              width: context.w(AppSize.doctorAvatarSize),
                              height: context.w(AppSize.doctorAvatarSize),
                              child: DoctorPhoto(
                                doctor: doctor,
