...
class _HomeSearchBarState extends State<HomeSearchBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final iconSize = context.w(AppSize.iconSmall);
    final padH = context.w(AppSize.homeSearchPaddingH);
    final gap = context.w(AppSize.homeSearchIconGap);
    final padV = (context.w(AppSize.homeSearchHeight) - iconSize) / 2;
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(
            context.r(AppSize.homeSearchRadius),
          ),
